...
func registerSDKWords(r *eng.Registry, client *sdk.KiprioApiSuiteSDK) {
...
func runOp(client *sdk.KiprioApiSuiteSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
