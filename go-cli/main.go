// Command KiprioApiSuite-cli is a CLI + REPL for the KiprioApiSuite SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      KIPRIO_API_SUITE_APIKEY (api key), KIPRIO_API_SUITE_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: KIPRIO_API_SUITE_APIKEY carries the API key and
	// KIPRIO_API_SUITE_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("KIPRIO_API_SUITE_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("KIPRIO_API_SUITE_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewKiprioApiSuiteSDK(opts)
