# KiprioApiSuite SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KiprioApiSuiteSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KiprioApiSuiteSDK(...) and KiprioApiSuiteSDK.test(...) become
#      KiprioApiSuiteSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kiprioapisuite_sdk"
_SDK_CLASS = "KiprioApiSuiteSDK"
