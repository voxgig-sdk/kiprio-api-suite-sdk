# KiprioApiSuite Python SDK



The Python SDK for the KiprioApiSuite API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/kiprio-api-suite-sdk/releases)) or
...
client = KiprioApiSuiteSDK({
    "apikey": os.environ.get("KIPRIO_API_SUITE_APIKEY"),
})
```
...
client = KiprioApiSuiteSDK(options)
```
...
```
py/
├── kiprioapisuite_sdk.py         -- Main SDK module
