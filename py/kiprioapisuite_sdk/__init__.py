...
from kiprioapisuite_sdk.utility import register

# Load features
from kiprioapisuite_sdk.feature.base_feature import KiprioApiSuiteBaseFeature
from kiprioapisuite_sdk.features import _has_feature, _make_feature


class KiprioApiSuiteSDK:
    ...
    def get_utility(self):
        return KiprioApiSuiteUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "KiprioApiSuiteSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KiprioApiSuiteSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DnsResult(self, data=None) -> "DnsResultEntity":
        ...
        from kiprioapisuite_sdk.entity.dns_result_entity import DnsResultEntity
    ...
    def Domain(self, data=None) -> "DomainEntity":
        ...
        from kiprioapisuite_sdk.entity.domain_entity import DomainEntity
    ...
    def EmailValidate(self, data=None) -> "EmailValidateEntity":
        ...
        from kiprioapisuite_sdk.entity.email_validate_entity import EmailValidateEntity
    ...
    def Generate(self, data=None) -> "GenerateEntity":
        ...
        from kiprioapisuite_sdk.entity.generate_entity import GenerateEntity
    ...
    def Utility(self, data=None) -> "UtilityEntity":
        ...
        from kiprioapisuite_sdk.entity.utility_entity import UtilityEntity
        return UtilityEntity(self, data)


    def Whoi(self, data=None) -> "WhoiEntity":
        """Entity factory: client.Whoi().list() / client.Whoi().load({"id": ...})."""
        from kiprioapisuite_sdk.entity.whoi_entity import WhoiEntity
        return WhoiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "KiprioApiSuiteSDK":
        if sdkopts is None:
            sdkopts = {}
