...
// KiprioApiSuite SDK timeout feature
...
class KiprioApiSuiteTimeoutFeature extends KiprioApiSuiteBaseFeature
{
    ...
    private function _with_timeout(KiprioApiSuiteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KiprioApiSuiteContext $_ctx, float $ms): void
    {
        $client = $this->client;
