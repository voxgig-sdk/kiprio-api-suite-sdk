...
// KiprioApiSuite SDK idempotency feature
...
class KiprioApiSuiteIdempotencyFeature extends KiprioApiSuiteBaseFeature
{
    ...
    private function _mutating(KiprioApiSuiteContext $ctx): bool
    {
