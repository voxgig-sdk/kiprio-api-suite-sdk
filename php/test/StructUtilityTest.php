...
// KiprioApiSuite SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KiprioApiSuiteOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KiprioApiSuiteOmni::structfix($now, Struct::undef()))
                        !== json_encode(KiprioApiSuiteOmni::structfix($val, Struct::undef()))) {
