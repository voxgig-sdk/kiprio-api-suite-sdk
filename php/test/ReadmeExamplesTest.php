...
// KiprioApiSuite SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KiprioApiSuiteSDK::test)
...
{
    private const SDK_CLASS = 'KiprioApiSuiteSDK';
    ...
    private const SDK_BASE = 'kiprioapisuite_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../kiprioapisuite_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
