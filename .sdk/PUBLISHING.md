...
|---|---|---|
| `ts/` | @voxgig-sdk/kiprio-api-suite-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kiprio-api-suite-sdk \
      --repository voxgig-sdk/kiprio-api-suite-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kiprio-api-suite-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kiprio-api-suite-sdk --id=<id>` removes it.
