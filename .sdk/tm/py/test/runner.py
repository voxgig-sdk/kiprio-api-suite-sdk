...
class KiprioApiSuiteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KiprioApiSuiteTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = KiprioApiSuiteTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = KiprioApiSuiteTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
