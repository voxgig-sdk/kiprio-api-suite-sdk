...
class KiprioApiSuiteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KiprioApiSuiteTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = KiprioApiSuiteTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = KiprioApiSuiteTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
