...
// KiprioApiSuite SDK rbac feature
...
class KiprioApiSuiteRbacFeature extends KiprioApiSuiteBaseFeature
{
    ...
    private function _required(KiprioApiSuiteContext $ctx): ?string
    {
    ...
    private function _reject(KiprioApiSuiteContext $ctx, string $required): void
    {
    ...
    private function _track(KiprioApiSuiteContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
