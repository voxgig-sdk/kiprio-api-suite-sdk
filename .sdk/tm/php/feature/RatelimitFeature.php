...
// KiprioApiSuite SDK ratelimit feature
...
class KiprioApiSuiteRatelimitFeature extends KiprioApiSuiteBaseFeature
{
    ...
    private function _acquire(KiprioApiSuiteContext $ctx): void
    {
    ...
    private function _track(KiprioApiSuiteContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
