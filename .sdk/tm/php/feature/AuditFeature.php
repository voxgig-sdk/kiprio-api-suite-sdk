...
// KiprioApiSuite SDK audit feature
...
class KiprioApiSuiteAuditFeature extends KiprioApiSuiteBaseFeature
{
    ...
    private function _emit(KiprioApiSuiteContext $ctx, string $outcome): void
    {
