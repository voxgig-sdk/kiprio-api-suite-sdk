...
// KiprioApiSuite SDK proxy feature
...
class KiprioApiSuiteProxyFeature extends KiprioApiSuiteBaseFeature
{
    ...
    public function init(KiprioApiSuiteContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KiprioApiSuiteContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
