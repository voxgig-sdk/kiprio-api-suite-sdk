...
// KiprioApiSuite SDK netsim feature
...
class KiprioApiSuiteNetsimFeature extends KiprioApiSuiteBaseFeature
{
    ...
    private function _simulate(KiprioApiSuiteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KiprioApiSuiteContext $ctx, array $applied): void
    {
        $client = $this->client;
