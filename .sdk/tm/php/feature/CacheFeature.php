...
// KiprioApiSuite SDK cache feature
...
class KiprioApiSuiteCacheFeature extends KiprioApiSuiteBaseFeature
{
    ...
    private function _through(KiprioApiSuiteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
