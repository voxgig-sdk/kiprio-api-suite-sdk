...
// KiprioApiSuite SDK utility: graphql
//
...
class KiprioApiSuiteGraphql
{
    ...
    // equivalent.
    public static function body(KiprioApiSuiteContext $ctx): mixed
    {
    ...
    public static function errors(KiprioApiSuiteContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
