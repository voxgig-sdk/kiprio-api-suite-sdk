...
// KiprioApiSuite SDK utility: fetcher

class KiprioApiSuiteFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KiprioApiSuiteSDK/1.0)';
    ...
    public static function call(KiprioApiSuiteContext $ctx, string $fullurl, array $fetchdef): array
    {
