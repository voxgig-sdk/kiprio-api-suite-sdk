...
// KiprioApiSuite SDK utility type

class KiprioApiSuiteUtility
{
    ...
    public static function copy(KiprioApiSuiteUtility $src): KiprioApiSuiteUtility
    {
        $u = new KiprioApiSuiteUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
