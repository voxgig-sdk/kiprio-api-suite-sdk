...
func registerTools(server *mcp.Server, client *sdk.KiprioApiSuiteSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kiprio-api-suite_list",
		Description: "List records from KiprioApiSuite. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kiprio-api-suite_load",
		Description: "Load a single record from KiprioApiSuite. " +
...
func runOp(client *sdk.KiprioApiSuiteSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KiprioApiSuiteSDK, name string) (sdk.KiprioApiSuiteEntity, error) {
