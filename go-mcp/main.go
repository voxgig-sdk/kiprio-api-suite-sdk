// Command KiprioApiSuite-mcp is an MCP server exposing the KiprioApiSuite
// SDK as MCP tools.
//
// Two tools are registered:
//
//	KiprioApiSuite_list  — list records of an entity
//	KiprioApiSuite_load  — load a single record of an entity
//
