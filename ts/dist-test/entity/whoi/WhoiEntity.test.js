...
(0, node_test_1.describe)('WhoiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set KIPRIO_API_SUITE_TEST_WHOI_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['KIPRIO_API_SUITE_TEST_WHOI_ENTID'];
    ...
    idmap = env['KIPRIO_API_SUITE_TEST_WHOI_ENTID'];
