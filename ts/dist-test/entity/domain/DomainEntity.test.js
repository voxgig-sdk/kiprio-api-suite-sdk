...
(0, node_test_1.describe)('DomainEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set KIPRIO_API_SUITE_TEST_DOMAIN_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['KIPRIO_API_SUITE_TEST_DOMAIN_ENTID'];
    ...
    idmap = env['KIPRIO_API_SUITE_TEST_DOMAIN_ENTID'];
