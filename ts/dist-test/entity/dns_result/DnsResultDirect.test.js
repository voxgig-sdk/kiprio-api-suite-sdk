...
(0, node_test_1.describe)('DnsResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.KiprioApiSuiteSDK({
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.KiprioApiSuiteSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.KIPRIO_API_SUITE_APIKEY,
        }));
        let idmap = env['KIPRIO_API_SUITE_TEST_DNS_RESULT_ENTID'];
    ...
    const client = new __1.KiprioApiSuiteSDK({
        base: 'http://localhost:8080',
