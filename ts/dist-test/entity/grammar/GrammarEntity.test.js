...
(0, node_test_1.describe)('GrammarEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set KIPRIO_API_SUITE_TEST_GRAMMAR_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['KIPRIO_API_SUITE_TEST_GRAMMAR_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'KIPRIO_API_SUITE_TEST_GRAMMAR_ENTID': idmap,
        'KIPRIO_API_SUITE_TEST_LIVE': 'FALSE',
        'KIPRIO_API_SUITE_TEST_EXPLAIN': 'FALSE',
        'KIPRIO_API_SUITE_APIKEY': '',
    });
    idmap = env['KIPRIO_API_SUITE_TEST_GRAMMAR_ENTID'];
