...
function runner.env_override(m)
  local live = runner.getenv("KIPRIOAPISUITE_TEST_LIVE")
  local override = runner.getenv("KIPRIOAPISUITE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KIPRIOAPISUITE_TEST_EXPLAIN")
