...
function runner.env_override(m)
  local live = runner.getenv("KIPRIO_API_SUITE_TEST_LIVE")
  local override = runner.getenv("KIPRIO_API_SUITE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KIPRIO_API_SUITE_TEST_EXPLAIN")
