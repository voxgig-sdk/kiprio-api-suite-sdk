...
require("kiprio-api-suite_types")
...
local KiprioApiSuiteSDK = {}
KiprioApiSuiteSDK.__index = KiprioApiSuiteSDK
...
KiprioApiSuiteSDK._make_feature = _make_feature


function KiprioApiSuiteSDK.new(options)
  local self = setmetatable({}, KiprioApiSuiteSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KiprioApiSuiteSDK:options_map()
...
function KiprioApiSuiteSDK:get_utility()
  return Utility.copy(self._utility)
end


function KiprioApiSuiteSDK:get_root_ctx()
  return self._rootctx
end


function KiprioApiSuiteSDK:prepare(fetchargs)
...
function KiprioApiSuiteSDK:direct(fetchargs)
...
-- by passing it.
function KiprioApiSuiteSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KiprioApiSuiteSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "KiprioApiSuiteSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function KiprioApiSuiteSDK:DnsResult(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:Domain(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:EmailValidate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:Generate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:Grammar(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:Ipn(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:Redact(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:Ssl(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:Utility(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function KiprioApiSuiteSDK:Whoi(data)
...
function KiprioApiSuiteSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KiprioApiSuiteSDK.new(sdkopts)
  sdk.mode = "test"
