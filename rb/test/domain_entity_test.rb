...
class DomainEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set KIPRIO_API_SUITE_TEST_DOMAIN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def domain_basic_setup(extra)
  ...
  entid_env_raw = ENV["KIPRIO_API_SUITE_TEST_DOMAIN_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["KIPRIO_API_SUITE_TEST_DOMAIN_ENTID"])
