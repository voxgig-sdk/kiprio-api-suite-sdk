...
func TestRedactEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set KIPRIOAPISUITE_TEST_REDACT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func redactBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("KIPRIOAPISUITE_TEST_REDACT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["KIPRIOAPISUITE_TEST_REDACT_ENTID"])
