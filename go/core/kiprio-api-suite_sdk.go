...
import (
	...
	vs "github.com/voxgig-sdk/kiprio-api-suite-sdk/go/utility/struct"
)

type KiprioApiSuiteSDK struct {
	Mode     string
...
func (sdk *KiprioApiSuiteSDK) OptionsMap() map[string]any {
...
func (sdk *KiprioApiSuiteSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *KiprioApiSuiteSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *KiprioApiSuiteSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KiprioApiSuiteSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *KiprioApiSuiteSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *KiprioApiSuiteSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("KiprioApiSuiteSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *KiprioApiSuiteSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KiprioApiSuiteSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("KiprioApiSuiteSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *KiprioApiSuiteSDK) DnsResult(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) Domain(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) EmailValidate(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) Generate(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) Grammar(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) Ipn(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) Redact(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) Ssl(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) Utility(data map[string]any) KiprioApiSuiteEntity {
...
func (sdk *KiprioApiSuiteSDK) Whoi(data map[string]any) KiprioApiSuiteEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *KiprioApiSuiteSDK {
	...
	sdk := NewKiprioApiSuiteSDK(sdkopts)
	sdk.Mode = "test"
